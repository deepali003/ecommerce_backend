                    ...
                    <table>
                      <tr>
                        <td>
                          ...
                          @if(!empty($categoryDetails->category_image))
                            <input type="hidden" name="current_image" value="{{ $categoryDetails->category_image }}"> 
                          @endif
                        </td>
                        <td>
                          @if(!empty($categoryDetails->category_image))
                            <img style="width:30px;" src="{{ asset($categoryDetails->category_image) }}"> | <a href="{{ url('/admin/delete-catgory-image/'.$categoryDetails->id) }}">Delete</a>
                          @endif
                        </td>
                      </tr>
                    </table>
