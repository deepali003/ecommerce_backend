            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">@foreach($order->orders as $pro){{ $pro->product_name }}<br>@endforeach</td>
                  <td class="center"> @foreach($order->orders as $pro)({{ $pro->product_qty }})<br>@endforeach</td>
