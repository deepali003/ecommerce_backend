  ...
  <ul>
    ...
    @if(Session::get('adminDetails')['products_access']==1)
     <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i>
      ...
      <ul <?php if (preg_match("/product/i", $url)){ ?> style="display: block;" <?php } ?>>
        ...
        <li <?php if (preg_match("/import-products/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/import-products')}}">Import Products</a></li>
      </ul>
    </li>
    @endif
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Users</span> <span class="label label-important">1</span></a>
      <ul <?php if (preg_match("/users/i", $url)){ ?> style="display: block;" <?php } ?>>
        ...
        <li <?php if ($base_user_url=="import-users"){ ?> class="active" <?php } ?>><a href="{{ url('/admin/import-users')}}">Import Users</a></li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Mobile</span> </a>
      <ul <?php if (preg_match("/shipping/i", $url)){ ?> style="display: block;" <?php } ?>>
        <li <?php if (preg_match("/add-mobile/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/add-mobile')}}">Add Mobile no.</a></li>
        <li <?php if (preg_match("/add-mobile/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/view-mobile')}}">View Mobile no.</a></li>
      </ul>
    </li>
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Share App</span> </a>
      <ul <?php if (preg_match("/shipping/i", $url)){ ?> style="display: block;" <?php } ?>>
        <li <?php if (preg_match("/add-app/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/add-app')}}">Add </a></li>
        <li <?php if (preg_match("/add-view-app/i", $url)){ ?> class="active" <?php } ?>><a href="{{ url('/admin/view-app')}}">View</a></li>
      </ul>
    </li>
  </ul>
</div>
