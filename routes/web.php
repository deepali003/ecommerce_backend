...
Route::group(['middleware' => ['adminlogin']], function () {
	...
	Route::get('/admin/import-users','UsersController@importUsersList');
	Route::post('/admin/importusers','UsersController@importUsers')->name('import');

	Route::get('/admin/import-products','ProductsController@importProductsList');
	Route::post('/admin/importproducts','ProductsController@importProducts')->name('import');
	...
	//Mobile no.
	Route::get('admin/add-mobile','MobileController@index');
	Route::post('admin/insertMobile','MobileController@store');
	Route::get('admin/view-mobile','MobileController@show');
	Route::get('admin/edit-mobile/{id}','MobileController@edit');
	Route::post('admin/updateMobile/{id}','MobileController@update');
	// Route::get('admin/deleteMobile/{id}','MobileController@destroy');

	//share app
	Route::get('admin/add-app','ShareAppController@index');
	Route::post('admin/insertApp','ShareAppController@store');
	Route::get('admin/view-app','ShareAppController@show');
	Route::get('admin/edit-app/{id}','ShareAppController@edit');
	Route::post('admin/updateApp/{id}','ShareAppController@update');
});
